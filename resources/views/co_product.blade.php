                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="outer">
                                <div id="big" class="owl-carousel owl-theme">
                                    <div class="item">
                                        <img src="../assets/images/productsimages/{{$product->image1}}" alt="logo">
                                    </div>
                                    @if(($product->image2)!=null)
                                    <div class="item">
                                        <img src="../assets/images/productsimages/{{$product->image2}}" alt="logo">
                                    </div>
                                    @endif
                                    
                                    @if(($product->image3)!=null)
                                    <div class="item">
                                        <img src="../assets/images/productsimages/{{$product->image3}}" alt="logo">
                                    </div>
                                    @endif
                                    
                                    @if(($product->image4)!=null)
                                    <div class="item">
                                        <img src="../assets/images/productsimages/{{$product->image4}}" alt="logo">
                                    </div>
                                    @endif
                        ...
                        <div class="col-lg-6 rtl-text">
                            <div class="product-right">
                                <h2>{{$product->name}} ظرفیت {{$product->storage}} گیگابایت</h2>

                                @if(!auth()->user())
                                    <h3>{{$product->customerprice}} تومان</h3>
                                @elseif(auth()->user()->branch==1)
                                    <h3>{{$product->branchprice}} تومان</h3>
                                @else
                                    <h3>{{$product->customerprice}} تومان</h3>
                                @endif
                                ...
                                <div class="product-buttons">
                                    <a class="theme_btn" href="/cart">سبد خرید
                                        <span class="theme_btn_eff"></span>
                                    </a>
                                    
                                <a class="theme_btn" href="/shop">بازگشت
                                        <span class="theme_btn_eff"></span>
                                    </a>
                                ...
                                <div class="border-product">
                                    <h6 class="product-title">هشدار سامانه همتا</h6>
                                    حتما در زمان تحویل دستگاه، به کمک کد فعال‌سازی چاپ شده روی جعبه یا کارت گارانتی، دستگاه را از طریق #7777*، برای سیم‌کارت خود فعال‌سازی کنید. آموزش تصویری در آدرس اینترنتی hmti.ir/05
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-12">
                                <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                    <li class="nav-item"><a class="nav-link active" id="top-home-tab" data-toggle="tab" href="#top-home" role="tab" aria-selected="true"><i class="icofont icofont-ui-home"></i>توضیحات</a>
                                        <div class="material-border"></div>
                                    </li>
                                    <li class="nav-item"><a class="nav-link" id="profile-top-tab" data-toggle="tab" href="#top-profile" role="tab" aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>جزئیات</a>
                                        <div class="material-border"></div>
                                    </li>
                        ...
                        <div class="product-service mb-0">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>حمل و نقل رایگان در سراسر ایران</p>
                                </div>
                            </div>
                            <div class="media">
                    ...
                    <div class="theme-card" data-aos="fade-up"
                        ...
                        <div class="offer-slider slide-1 collection-filter-block">
                            <div class="mb-0">
                                @foreach($latest as $l)
                                <div class="media">
                                        <a href="#"><img class="img-fluid" src="../assets/images/productsimages/{{$l->image1}}" alt=""></a>
                                        <div class="media-body align-self-center">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div><a href="#"><h6>{{$l->name}}</h6></a>
                                            <h4>{{$l->price}} تومان</h4></div>
                                    </div>
                                    <br>
