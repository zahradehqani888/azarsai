                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 contact_text">
                            ...
                            <p>برای اطلاع از وضعیت تعمیر گوشی، اطلاعات خواسته شده را از طریق فرم روبرو ارسال نمایید.  </p>
                            <p> کد IMEI را با شماره گیری #06#* می توانید به دست آورید.</p>
                                ...
                                <div class="container bg-transparent">
                                    <div class="row">
                                        <div class="col-12 quote_form">
                                            <h3 class="page-header-comment mb-4">پیگیری تعمیرات</h3>
                                            ...
                                            <?php endif; ?>
                                            <form action="/rapair_status" method="post">
                                                    @csrf
                                                <div class="form-group ">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        {{--<div class="form-group ">
                                                            <div class="row">
                                                                <label>کد پیگیری :</label><span class="error" style="color:#dc3545">*</span>
