                                ...
                                <div class="container bg-transparent">
                                    <div class="row">
                                        <div class="col-12 quote_form">
                                            ...
                                            <?php endif; ?>
                                            <form action="/add_opinion2"method="post">
                                                @csrf
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text"name="serial_no" class="form-control" placeholder="شماره سریال یک کد 16 رقمی است."value="{{old('serial_no')}}" >
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label>تاریخ خرید :</label><span class="error" style="color:#dc3545">*</span>
                                                        <input type="text"name="buy_date" class="form-control" placeholder="yyyy/mm/dd"value="{{old('buy_date')}}" >
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>نام نمایندگی :</label><span class="error" style="color:#dc3545">*</span>
                                                        <input type="text"name="branch_name" class="form-control" value="{{old('branch_name')}}" >
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label>شهر :</label><span class="error" style="color:#dc3545">*</span>
                                                    ...
                                                    <div class="form-control">
                                                        ...
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q1" value="1">ضعیف
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q1" value="2" >متوسط
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q1" value="3">خوب
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="q1" value="4">عالی
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-control" style="margin-top:20px;">
                                                        ...
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q2" value="1" >ضعیف
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q2" value="2">متوسط
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q2" value="3"> خوب
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="q2" value="4">عالی
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-control" style="margin-top:20px;">
                                                        ...
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q3" value="1" >ضعیف
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q3" value="2">متوسط
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q3" value="3"> خوب
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="q3" value="4">عالی
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-control" style="margin-top:20px;">
                                                        ...
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q4" value="1" >ضعیف
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q4" value="2">متوسط
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q4" value="3"> خوب
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="q4" value="4">عالی
                                                        </label>
                                                    </div>

                                                    <div class="form-control" style="margin-top:20px;">
                                                        <div class="form-group col-md-12"><span class="error" style="color:#dc3545">*</span>
                                                            <label >5. تعهد نمایندگی در خصوص مدت زمان تعمیر :</label><br>
                                                        </div>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q5" value="1" >ضعیف
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q5" value="2">متوسط
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q5" value="3"> خوب
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="q5" value="4">عالی
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-control" style="margin-top:20px;">
                                                        ...
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q6" value="1" >ضعیف
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q6" value="2">متوسط
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q6" value="3"> خوب
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="q6" value="4">عالی
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-control" style="margin-top:20px;">
                                                        ...
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q7" value="1" >ضعیف
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q7" value="2">متوسط
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q7" value="3"> خوب
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="q7" value="4">عالی
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-control" style="margin-top:20px;">
                                                        ...
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q8" value="1" >ضعیف
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q8" value="2">متوسط
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q8" value="3"> خوب
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="q8" value="4">عالی
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-control" style="margin-top:20px;">
                                                        ...
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q9" value="1" >بله
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q9" value="2">خیر
                                                        </label>
                                                    ...
                                                    <div class="form-control" style="margin-top:20px;">
                                                        ...
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q10" value="1" >بله
                                                        </label>
                                                        <label class="radio-inline" style="padding-left: 30px;">
                                                            <input type="radio" name="q10" value="2">خیر
                                                        </label>
